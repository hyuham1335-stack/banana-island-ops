...
| 필드 | 예 | 출처 |
|---|---|---|
| 발행 예정일 | 2026-09-17 | 구글 시트 콘텐츠 캘린더 |
| 채널 | 네이버 블로그 | 시트 |
| 제품 | 그린바나나가루 300g (비어 있을 수 있음 — 브랜드 소식형) | 시트 |
| 언어 | ko / en | 시트 |
| 글 유형 | 건강정보형 / 활동소식형 / 비교큐레이션형 / 후기리뷰형 | 시트 |
| 주제·메모 | 저GI 베이킹 기초 | 시트 |
| 담당자 | 마케팅 담당 | 시트 (이름 매칭, 실패 시 비움) |
...
|---|---|---|---|
| Q1 | 시트의 실제 컬럼 이름·순서·계획ID 열 | 목업 필드 7개, 첫 열이 계획ID | 사용자, 시트 접근 시 (FR-001 구현 전) |

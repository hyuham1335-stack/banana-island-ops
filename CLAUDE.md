...
**아래 여섯은 2026-09-13 에 채워졌다.** 문서가 하네스 설정의 **입력**이기 때문에 코드보다 먼저 채웠고, 무엇이 무엇의 입력인지는 `docs/harness/ROADMAP.md` §4 의 표에 있다. 원본 자료(사업계획서·목업·Miro ERD·메모)와 어긋나면 문서를 먼저 고친다.
